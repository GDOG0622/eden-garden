...
2. 你只负责更新"角色基本信息"中指定的那一个角色，对话中出现的其他角色与本次任务无关，绝对不可混淆。
3. 对话中没有明确提及的字段，保持原值不变（非孕时精子/卵子/胎数/父亲/健康写"N/A"）。
4. 根据时间和事件合理推断月经周期阶段、精子活性、卵子状态等生理细节。
5. 如有近亲关系，须在该前提下综合考量所有指标。
...
export function buildUserPrompt({
    ...
    return `⚠️ 本次任务：更新【${name}】的状态面板。对话中可能出现其他角色，请勿混淆——你只负责【${name}】，不是对话中的其他任何人。
